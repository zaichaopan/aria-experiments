  ...
  <div>
    <dl class="faq">
      <div class="disclosure">
        <dt>
          <button type="button">What do I do if I have a permit for an assigned lot, but can't find a space there?</button>
        </dt>
        <dd>
          <p class="desc">
      ...
      <div class="disclosure">
        <dt>
          <button type="button">What do I do if I lose my permit or if my permit is stolen?</button>
        </dt>
        <dd>
          <p class="desc">
      ...
      <div class="disclosure">
        <dt>
          <button type="button">Is there free parking on holidays?</button>
        </dt>
        <dd>
          <p class="desc">
      ...
      <div class="disclosure">
        <dt>
          <button type="button">Do all parking facilities have the same enforcement rules?</button>
        </dt>
        <dd>
          <p class="desc">
